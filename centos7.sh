...
wget https://github.com/cunghocweb/cunghocweb_openvpn/raw/main/openvpn-as-2.5-CentOS7.x86_64.rpm
rpm -i openvpn-as-2.5-CentOS7.x86_64.rpm
cd /usr/local/openvpn_as/lib/python2.7/site-packages/
rm pyovpn-2.0-py2.7.egg
wget https://github.com/cunghocweb/cunghocweb_openvpn/raw/main/pyovpn-2.0-py2.7.egg
